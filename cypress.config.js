      ...
      on('task', {
        generateUser() {
          ...
          return {
            ...
            password: '12345Qwert!',
            artTitle: generateRandomEnglishString(7) + randomNumber,
            artDescribe: generateRandomEnglishString(15) + randomNumber,
            artBody: generateRandomEnglishString(30) + randomNumber
          };
        }
      });
    }
